...
var firstNameList = require(__dirname + "/firstNames.js");
var lastNameList = require(__dirname + "/lastNames.js");
var streetNameList = require(__dirname + "/streetNames.js");
var cityNameList = require(__dirname + "/cityNames.js");
var stateNameList = require(__dirname + "/stateNames.js");
var countryNameList = require(__dirname + "/countryNames.js");
...
function generateDistributorData() {
    ...
    for (var i = 0; i < 5; i++) {
        var json = {};
        json.op_id = getRandomInteger(1000, 1010);
        json.dist_id = uuid.v1();
        ...
        for (var j = 0; j < 3; j++) {
            var rnd_phn = {};
            rnd_phn.isd = "+91";
            rnd_phn.num = getRandomInteger(8888888888, 9999999999);
        ...
        json.addr.pin = getRandomInteger(100000, 100020);
